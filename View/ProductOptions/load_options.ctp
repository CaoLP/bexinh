            ...
            <div class="list-group-item">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-6">
                            <div class="checkbox">
                                <input type="checkbox"  name="data[WarehouseOption][<?php echo $key?>][options]" class="option-checkbox" id="flat-checkbox-<?php echo $key; ?>" value="<?php echo implode($option['option'],',') ?>">
                                <label for="flat-checkbox-<?php echo $key; ?>"><?php echo implode($option['name'],',') ?></label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <input class="form-control input-sm" name="data[WarehouseOption][<?php echo $key?>][qty]" value="0">
                        </div>
                    </div>
                </div>
            </div>
