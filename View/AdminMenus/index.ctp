...
<div class="panel-body">
    <div class="col-md-12">
        <ul class="nav nav-pills nav-justified">
			<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Admin Menu'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('group_ids'); ?></th>
				...
				<?php foreach ($adminMenus as $adminMenu): ?>
					<tr>
						<td><?php echo h($adminMenu['AdminMenu']['id']); ?>&nbsp;</td>
						...
						<td><?php echo h($adminMenu['AdminMenu']['group_ids']); ?>&nbsp;</td>
								<td>
